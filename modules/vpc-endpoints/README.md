...
See [`examples`](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples) directory for working examples to reference:

```hcl
module "endpoints" {
  source = "nholuongut/vpc/aws//modules/vpc-endpoints"
