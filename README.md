...
It is possible to integrate this VPC module with [terraform-aws-transit-gateway module](https://github.com/nholuongut/terraform-aws-transit-gateway) which handles the creation of TGW resources and VPC attachments. See [complete example there](https://github.com/nholuongut/terraform-aws-transit-gateway/tree/master/examples/complete).
...
- [Complete VPC](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/complete) with VPC Endpoints.
- [VPC using IPAM](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/ipam)
- [Dualstack IPv4/IPv6 VPC](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/ipv6-dualstack)
- [IPv6 only subnets/VPC](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/ipv6-only)
- [Manage Default VPC](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/manage-default-vpc)
- [Network ACL](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/network-acls)
- [VPC with Outpost](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/outpost)
- [VPC with secondary CIDR blocks](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/secondary-cidr-blocks)
- [VPC with unique route tables](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/separate-route-tables)
- [Simple VPC](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/simple)
- [VPC Flow Logs](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/vpc-flow-logs)
- [Few tests and edge case examples](https://github.com/nholuongut/terraform-aws-vpc/tree/master/examples/issues)

## Contributing

Report issues/questions/feature requests on in the [issues](https://github.com/nholuongut/terraform-aws-vpc/issues/new) section.
